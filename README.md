...
<head>
    ...
    <style>
        ...
        .icon {
            ...
            background-image: url('dist/editor@2x.png');
        }
...
<div id="editor">
    <p>
        <button @click="bold" class="icon icon-bold"></button>
    ...
    <textarea v-model="input" debounce="500" style="display: inline-block" rows="16"></textarea>
    <div>{{{ output }}}</div>
</div>
<script !src="">
